...
class CBandit:
    ...
    def step(self, a):
        ...
        #########################################
        ## INSERT YOUR CODE HERE
        r = 0 if np.random.uniform() > self.p[self.s, a] else 1
        s = 0 if np.random.uniform() > 0.5 else 1
        self.s = s
        #########################################
        return r, s
...
class Agent(object):
    ...
    def __init__(self, n, n_s, e=0.1):
        ...
        #########################################
        ## INSERT YOUR CODE HERE
        self.n, self.e, self.Q, self.c = n, e, np.zeros((n_s, n)), np.zeros((n_s, n))
        #########################################
   ...
   # ----------------------------------------------
    ...
    def update(self,s,a,r):
        ...
        #########################################
        ## INSERT YOUR CODE HERE
        self.Q[s, a] = (self.Q[s, a] * self.c[s, a] + r) / (self.c[s, a] + 1)
        self.c[s, a] += 1
        #########################################
